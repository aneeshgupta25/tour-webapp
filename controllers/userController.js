...
//     //new file name -> user-id-timestamp
//     const ext = file.mimetype.split('/')[1];
//     cb(null, `user-${req.user.id}-${Date.now()}.${ext}`);
//   },
// });
// SAVE image initially to buffer instead of memory to process
...
exports.resizeUserPhoto = catchAsync(async (req, res, next) => {
  ...
  // Need to set this since now image is being saved in memory, not in file
